...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<body>
		<ul id="nav">
			<li class="top">
				<a href="./userhome.do" class="top_link"><span>Home</span> </a>
			</li>
			<li class="top">
				...
				<ul class="sub">
					<li>
						<a href="./viewuserCountryDetails.do">View Countries</a>
					</li>
					<li>
						<a href="./viewUserCityAction.do">View Cities</a>
					</li>
			...
			<li class="top">
				...
				<ul class="sub">
					<li>
						<a href="./customerchangePassword1.do">ChangePassword</a>
					</li>
