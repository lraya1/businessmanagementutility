												...
												<h2>
													<font color="black">
														<p align="center">
															<fieldset>
																<legend>
																	<span class="style3">Order Details</span>
																</legend>
																<div align="center">
																	<form id="form2" method="post" action="UserSearch.jsp"
																		name="search"
																		onSubmit="javascript:if(document.search.brandid.value=='' && document.search.categoryid.value==''&& document.search.itemid.value==''){alert('select Any Search Criteria');}">
																	</form>

																</div>
																<form name="f" method="post"
																	action="DeleteBrandAction.jsp">
																	...
																	<div align="left">
																		...
																		<table width="510" border="0" align="center">
																			...
																			<%
																				try {
																					CoreHash aCoreHash = new OrdersDAO().listOrderDetails(Integer
																					...
																					if (!aCoreHash.isEmpty()) {
																						...
																						CoreHash cCoreHash = new GoodsMasterDao()
																								.listCategoryNames();
																			...
																			<tr>
																				...
																				<td bgcolor="#DDEAD7">
																					<div align="center">
																						<span class="style14"><%=cCoreHash.get(new Integer(aOrder
								.getCategoryid()))%></span>
																					</div>
																				</td>
																				<td bgcolor="#DDEAD7">
																					<div align="center">
																						<span class="style14"><%=iCoreHash
								.get(new Integer(aOrder.getItemid()))%></span>
																					</div>
																				</td>
																				<td bgcolor="#DDEAD7">
																				...
																				<td bgcolor="#DDEAD7">
																					<div align="center" class="style14">
																						<div align="center"><%=new GoodsDetailsDao().getBalance(aOrder
								.getItemid())%></div>
																					</div>
																				</td>
																			</tr>
