			...
			<tr>
								...
								<td>
									<font color="skyblue"><h1>
										...
										<p align="center">
											...
											%>
											<span class="style9"><b>Registeration Form </b>
											</span>
																...
																<td>
																	...
																	<form action="./RegisterAction" method="post"
																		...
																		<table border="1" bgcolor="skyblue"
																			...
																			<tr>
																				<td>
																					<b>Your EPost-Office Account gives you access
																						to view the EPost-Office details . If you already
																						have a EPost-Office Account, you can <a
																						href="index.jsp">sign in</a> here.</b>
				...
				out.print(request.getParameter("userName"));%>"
																						...
																						<tr>
																							...
																							<td width="255">
																								<input id="firstName" type="text"
																									name="firstName" onblur="strValidate(this)">
																							</td>
																						</tr>
																						<tr>
																							<td width="120">
																							...
																							<td width="273">
																								<font size="3" face="Verdana"> <input
																										type="text" name="lastName" value="" size="20"
																						...
																						<tr>
																							...
																							<td>
																								<font size="3" face="Verdana"> <input
																										type="text" name="dob" value="" size="20"
																										readonly /><a
																						...
																						<tr>
																							...
																							<td>
																								<input type="file" name="photo"
																									class="textfield" onChange="preview(this)" />
																							</td>
																						</tr>
																						<tr>
																							<td>
																						...
																						<tr>
																							...
																							<td>
																								<font size="3" face="Verdana"> <input
																										type="text" name="fax" value="" size="20" /> </font>
																							</td>
																						</tr>
																						<th colspan="2">
																						...
																						<tr>
																							...
																							<td>
																								<input type="text" name="street" value=""
																									size="20" onBlur="strValidate(this)" />
																							</td>
																						</tr>
																						<tr>
																							<td>
																						...
																						<tr>
																							...
																							<td>
																								<input type="text" name="phoneNo" value=""
																									size="20" onBlur="ValidateForm();abc()" />
																							</td>
																						</tr>
																						<th colspan="5">
																						...
																						<tr>
																							...
																							<td>
																								<select name="squest">
																									<option value="select" selected="true">
																										<font size="3" face="Verdana">--Select
																											One---</font>
																									</option>
																									<option value="What is your favorite pastime?">
																										<font size="3" face="Verdana">What is
																											your favorite pastime?</font>
																									</option>
																									...
																									<option
																										...
																										<font size="3" face="Verdana">What is
																											the name of your first school?</font>
																									</option>
																									<option value="Where did you meet your spouse?">
																										<font size="3" face="Verdana">Where did
																											you meet your spouse?</font>
																									</option>
																									<option
																										value="What is your favorite sports team?">
																										<font size="3" face="Verdana">What is
																											your favorite sports team?</font>
																									</option>
																									<option
																										value="What is your father middle name?">
																										<font size="3" face="Verdana">What is
																											your father middle name?</font>
																									</option>
																									<option
																										value="What was your high school mascot?">
																										<font size="3" face="Verdana">What was
																											your high school mascot?</font>
																									</option>
																									<option
																										value="What make was your first car or bike?">
																										<font size="3" face="Verdana">What make
																											was your first car or bike?</font>
																									</option>
																					...
																					<table width="350" border="0" align="center">
																						...
																						<tr>
																							...
																							<td width="273">
																								<font size="3" face="Verdana"> <input
																										type="text" id="city" name="city" size="20" />
																								</font>
																							</td>
																						</tr>
																						<tr>
																							...
																							<td>
																								<font size="3" face="Verdana"> <input
																										type="text" name="state" value="" size="20" />
																								</font>
																							</td>
																						</tr>
																						<tr>
																							...
																							<td>
																								<font size="3" face="Verdana"> <input
																										type="text" name="country" value="" size="20" />
																								</font>
																							</td>
																						</tr>
																						...
																						<tr>
																							...
																							<td>
																								<font size="3" face="Verdana"> <input
																										type="text" name="pin" value="" size="20"
...
frmvalidator.addValidation("fax", "age");
																	...
																	<tr>
																		<td align="center">
																			<a href="Registerform.jsp"><font color="black"><b>Register
																						form-----?</b>
																			</font>
																			</a>
																		</td>
																	...
																	<tr>
																		<td align="center">
																			<a href="Recoverpassword.jsp"><font color="black"><b>Recover
																						Form--?</b>
																			</font>
																			</a>
																		</td>
