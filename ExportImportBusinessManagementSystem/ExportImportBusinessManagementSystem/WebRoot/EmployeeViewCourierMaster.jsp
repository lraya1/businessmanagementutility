...
String tocityname=new CityMasterDao().getCityName(form.getToCityId());
 ...
 %>
 <tr bgcolor="skyblue">
 <td align="center"><font color="black"><b><%=form.getCourierDate() %></b></font></td>
 <%--<td align="center"><font color="black"><b><%=fromcountryname %></b></font></td>
 --%><td align="center"><font color="black"><b><%=tocountryname %></b></font></td>
 <td align="center"><font color="black"><b><%=fromcityname %></b></font></td>
 <td align="center"><font color="black"><b><%=tocityname %></b></font></td>
 <td align="center"><font color="black"><b><%=form.getCourierAmt() %></b></font></td>
 <td align="center"><font color="black"><b><%=form.getCourierDet() %></b></font></td>
 <td align="center"><font color="black"><b><%=form.getStatus() %></b></font></td>
 <%if(!form.getStatus().equalsIgnoreCase("Deliverd")){ %>
 <td align="center"><font color="black"><b><a href="UpdateCourierShipmentMaster.jsp?courierid=<%=form.getCourierId() %>"><font color="black">Change</font></a></b></font></td>
 <%} %>
 </tr>
 <%}report+="</table>";
