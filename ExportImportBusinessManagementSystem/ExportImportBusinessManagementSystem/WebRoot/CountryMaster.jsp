																...
																<center>
																	...
																	<form action="countryMasterAction.do" name="register">
																		<table align="center" bgcolor="skyblue">
																			...
																			<tr>
																				<td bgcolor="white">
																					<strong><font color="black">Abbreviation
																							:</font>
																					</strong>
																				</td>
																				<td bgcolor="white">
...
frmvalidator.addValidation("countryName", "maxlen=20",
		"Max length for countryName is 20");
frmvalidator.addValidation("countryName", "alpha",
		" countryName Alphabetic chars only");
