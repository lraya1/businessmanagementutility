   ...
   <center>
	...
	<%=request.getParameter("status") %><%} %>
      ...
      <select name="toCityId"> <option vale="">--Select Any One--</option>
			...
			<%} %></select></td></tr>
			<tr><td><font color="black"><b> Amt :</b></font> </td><td><input type=text name="courierAmt"/> </td></tr>
			<tr><td><font color="black"><b>Goods Details :</b></font> </td><td><input type=text name="courierDet"/> </td></tr>
			
		<input type="hidden"  name="userId" value="<%=userid %>"/>
						<tr><td><font color="black"><b>DeliveryDate : &nbsp;&nbsp;&nbsp;</b></font> </td><td><input type=text name="courierDate" readonly/><a href="javascript:show_calendar('document.register.courierDate', document.register.courierDate.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a> </td></tr>
