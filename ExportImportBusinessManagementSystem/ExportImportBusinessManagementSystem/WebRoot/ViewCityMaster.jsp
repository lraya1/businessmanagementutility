									...
									<font color="skyblue"><h1>
										...
										<p align="center" class="style3">
											...
											<p align="center">
												...
												<center>
													<h3>
														<font color="black"><strong>View City
																Details</strong>
														</font>
													</h3>
															...
															<tr bgcolor="white">
																<td colspan=2>
																	<div align="center" class="style2">
																		<strong><font color="black"><strong>CityName
																			</strong>
																		</font>
																		</strong>
																	</div>
																...
																<td>
																	<div align="center" class="style2">
																		<strong><font color="black"><strong>Zipcode</strong>
																		</font>
																		</strong>
																	</div>
																</td>
																...
																--><td>
																	<div align="center" class="style2">
																		<strong><font color="black"><strong>State</strong>
																		</font>
																		</strong>
																	</div>
																</td>
															...
															<tr bgcolor="skyblue">
																<td>
																	<input name="TypeId" type="checkbox"
																		value="<%=form.getCityId()%>">
																</td>
																<td>
																	<a
																		href="UpdateCityMaster.jsp?Id=<%=form.getCityId()%>"
																		class="style1"><font color="black"><u><%=form.getCityName()%></u>
																	</font>
																	</a>
																</td>
																<td>
																	<span class="style1"><font color="black"><%=form.getAbbr()%></font>
																	</span>
																</td>
																<!--<td>
																	<img src="images/<%=form.getCityMap()%>" width=50
																		height=50>
																</td>
																--><td>
																	<span class="style1"><font color="black"><%=form.getDescription()%></font>
																	</span>
																</td>
																<td>
																	<span class="style1"><font color="black"><%=form.getCountryname()%></font>
																	</span>
																</td>
															</tr>
															<%
