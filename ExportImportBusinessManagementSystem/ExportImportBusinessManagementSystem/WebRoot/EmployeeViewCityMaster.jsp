...
<td><div align="center" class="style2"><strong><font color="black"><strong>Zip code</strong></font></strong></div></td><!--           
<td><div align="center" class="style2"><strong><font color="black"><strong>CityMap</strong></font></strong></div></td>        
--><td><div align="center" class="style2"><strong><font color="black"><strong>State</strong></font></strong></div></td>
...
CityMasterForm form=(CityMasterForm)en.nextElement();
 %>
 <tr bgcolor="skyblue">
 <td><font color="black"><b><%=form.getCityName() %></b></font></td>
