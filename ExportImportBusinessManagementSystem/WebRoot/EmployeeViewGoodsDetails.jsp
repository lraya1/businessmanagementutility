...
.style3 {
	...
	<body>
		<table width="750" align="center" bgcolor="white">
			...
			<tr>
				<td bgcolor="skyblue"><jsp:include page="EmployeeOptions.jsp" /></td>
			</tr>
			<tr>
				<td>
					<%--<div align="center">--%>
								...
								<td>
									<font color="skyblue"><h1></h1>
										...
										<p align="center" class="style3">
											<center class="style3">
												<h2>
													<font color="black">Employee View Goods Details</font>
												</h2>
 ...
 GoodsDetailsForm form=(GoodsDetailsForm)en.nextElement();
  %>
														<tr bgcolor="white">
															...
															<td>
																<strong><span class="style3"><%=form.getItemName() %></span>
																</strong>
															</td>
															<td>
															...
															<td>
																<span class="style3"><strong><a
																		href="EmployeeWindowsMediaPlayer.jsp?videofile=<%=form.getItemLaunchVideo() %>">Play</a>
																</strong>
																</span>
															</td>
															<td>
